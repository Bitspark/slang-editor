...
import {GenericPortModel, PortModel} from "./abstract/port";
import {PortOwner} from "./abstract/port-owner";
import {IStreamPort} from "./abstract/stream";
import {SlangBehaviorSubject, SlangSubject} from "./abstract/utils/events";
...
export class StreamPort implements IStreamPort {
